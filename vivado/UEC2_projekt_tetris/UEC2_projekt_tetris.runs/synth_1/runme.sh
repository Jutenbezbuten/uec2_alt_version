...
HD_PWD='C:/Users/Juten/Desktop/nowy tetris xD/uec2_projekt/vivado/UEC2_projekt_tetris/UEC2_projekt_tetris.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TETRIS_Main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TETRIS_Main.tcl
