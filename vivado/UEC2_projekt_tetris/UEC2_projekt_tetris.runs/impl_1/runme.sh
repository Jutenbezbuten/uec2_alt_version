...
HD_PWD='C:/Users/Juten/Desktop/nowy tetris xD/uec2_projekt/vivado/UEC2_projekt_tetris/UEC2_projekt_tetris.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TETRIS_Main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TETRIS_Main.tcl -notrace
